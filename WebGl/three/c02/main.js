...
function main() {
  ...
  groundMesh.rotation.x = Math.PI * -.5; // in plain xoz
  ...
  function render(time) {
    ...
    // move target
    targetOrbit.rotation.y = time * .27; // rotation around y
    targetBob.position.y = Math.sin(time * 2) * 4; // perk up and down

    targetMesh.rotation.x = time * 7;
    targetMesh.rotation.y = time * 13; // self rotation
